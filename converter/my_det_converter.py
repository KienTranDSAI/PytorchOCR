...
class PPOCRv3DetConverter(BaseOCRV20):
    ...
    def load_paddle_weights(self, weights_path):
        ...
        # from paddle.base.dygraph import load_dygraph
        # print(weights_path)
        # import paddle
        # para_state_dict, opti_state_dict = paddle.load(weights_path + ".pdparams"),paddle.load(weights_path + ".pdopt")
...
if __name__ == '__main__':
    ...
    save_name = './pretrained_models/ch_ptocr_v3_det_distull_student.pth'
